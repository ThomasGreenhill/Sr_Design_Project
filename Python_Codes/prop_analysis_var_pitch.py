...
if __name__ == '__main__':
    ...
    for ii in range(ll):
        J_var[ii], P_design_Var[ii], T_design_var[ii], eta_P_var[ii], deta_P[ii], dT[ii], delta_bet[ii], RPM_fix[ii] = prop_analysis_var_pitch(v_seq[ii], P_eng_data, is_HP, atm_check, prop_check, m0_fn, Cd_fn)
