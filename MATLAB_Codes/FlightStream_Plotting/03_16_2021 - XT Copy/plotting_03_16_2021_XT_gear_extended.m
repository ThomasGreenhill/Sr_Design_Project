...
hold off
legend("No Flap", "Flap Up 4$^{\circ}$", "Flap Down 4$^{\circ}$", 'Location', 'northwest')
...
title(["Lift Coefficient vs. Angle of Attack for Jiffy Jerboa", "During Cruise: 62 m/s with Varying Flap Deflection (Gear Extended)"], 'FontSize', sizeFont)
saveas(gcf,"./Figures/CLva_all_ext.jpg")

% Landing
figure
figure('Renderer', 'painters', 'Position', sizeFig)
plot(alp_landl, CL_landl, 'DisplayName', "Flap Down 4$^{\circ}$")
legend("Flap Down 4$^{\circ}$", 'Location', 'northwest')
xlabel("Angle of Attack $\alpha$ (deg)", 'FontSize', sizeFont)
ylabel("Lift Coefficient $C_L$", 'FontSize', sizeFont)
xticks(alf_ticks_long)
yticks(CL_ticks_long)
title(["Lift Coefficient vs. Angle of Attack for Jiffy Jerboa", "During Landing with Flap Down 4$^{\circ}$ (Gear Extended)"], 'FontSize', sizeFont)
saveas(gcf,"./Figures/CLva_land_ext.jpg")
...
hold off
legend("No Flap Deflection", "Flap Up 4$^{\circ}$", "Flap Down 4$^{\circ}$", 'Location', 'northwest')
...
title(["Drag Coefficient vs. Lift Coefficient for Jiffy Jerboa", "During Cruise: 62 m/s with Varying Flap Deflection (Gear Extended)"], 'FontSize', sizeFont)
saveas(gcf,"./Figures/CDvCL_62_long_ext.jpg")

% Landing v = 38 m/s
figure
figure('Renderer', 'painters', 'Position', sizeFig)
plot(CL_landl, CD_landl, 'DisplayName', "No Flap Deflection")
legend("No Flap Deflection", 'Location', 'northwest')
xlabel("Lift Coefficient $C_L$", 'FontSize', sizeFont)
ylabel("Total Airframe Drag Coefficient $C_D$", 'FontSize', sizeFont)
xticks(CL_ticks_long)
yticks(CD_ticks_long)
title(["Drag Coefficient vs. Lift Coefficient for Jiffy Jerboa", "During Landing with Flap Down 4$^{\circ}$ (Gear Extended)"], 'FontSize', sizeFont)
saveas(gcf,"./Figures/CDvCL_land_long_ext.jpg")
...
xlim([-0.25, 0.75])
title(["Zoomed Drag Coefficient vs. Lift Coefficient for Jiffy Jerboa", "During Cruise: 62 m/s with Varying Flap Deflection (Gear Extended)"], 'FontSize', sizeFont)
text(CL_fu_62z(29)+0.05,CDo,strcat("$C_{D_{0_{ext}}} =",num2str(CDo,4),"$"),'fontsize',18)
saveas(gcf,"./Figures/CDvCL_62_zoomed_ext.jpg")
...
yticks(CD_ticks_zoomed)
xlim([-0.25, 0.75])
scatter(0, CDo,1000,'+','k', 'DisplayName', '$C_{D_o}$')
...
xticks(CL_ticks_zoomed)
yticks(CD_ticks_zoomed)
title(["Zoomed Drag Coefficient vs. Lift Coefficient for Jiffy Jerboa", "During Landing with Flap Down 4$^{\circ}$ (Gear Extended)"], 'FontSize', sizeFont)
saveas(gcf,"./Figures/CDvCL_land_zoomed_ext.jpg")
